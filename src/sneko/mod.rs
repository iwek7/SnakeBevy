...
use rand::Rng;
use crate::components::{DespawnOnLoss, Direction, Food, FoodBundle, GameLostEvent, GlobalGameState, SnakeSegment, SnakeSegmentBundle};
use crate::components::Direction::{DOWN, LEFT, RIGHT, UP};
use crate::config::{BACKGROUND_COLOR, BACKGROUND_Z, CELL_SIZE, DOTS_COLOR, DOTS_Z, DOT_RADIUS, FOOD_COLOR, FOOD_RADIUS, GRID_SIZE, SNAKE_COLOR, SNAKE_HEAD_COLOR, SNAKE_HEAD_Z, SNAKE_SIZE, SNAKE_Z};
